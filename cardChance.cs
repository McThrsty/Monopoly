...
[CreateAssetMenu(fileName = "New Chance Card", menuName = "Create Chance Card")]
public class cardChance : ScriptableObject
{
    public eCardType cardType;
    public eChanceCards chanceCards;
    ...
    public void PayBankCard()
    {
        ...
        curPlayer.UpdateCash(curPlayer.cashOnHand  - amount);
    }
